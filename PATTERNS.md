...
| If-else routing chains that should table-drive | contract | Evidence: popped/pushed stack-effect classifiers (5287b36ca). Traps: branches with real side effects, order-dependent guards. |
