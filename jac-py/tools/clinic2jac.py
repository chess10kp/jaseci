...
Jac backend for CPython libclinic. Reuses
...
FIXTURE_PATH = os.path.join(
    _REPO, "jac-py", "tools", "fixtures", "bool_new.c"
)
OUT_PATH = os.path.join(_REPO, "jac-py", "tools", "fixtures", "bool_new.expected.jac")
FIXTURE_PROVENANCE = "jac-py/tools/fixtures/bool_new.c"
...
def generate_text() -> str:
    ...
    out.append("(CPython pin: see tools/fetch_cpython_reference.py). Do not edit by hand — regenerate instead.")
    out.append('"""')
    out.append("")
    for func in funcs:
