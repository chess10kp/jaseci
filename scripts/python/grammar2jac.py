...
Usage:
    python scripts/python/grammar2jac.py
    python scripts/python/grammar2jac.py --check
    python scripts/python/grammar2jac.py --stdout
"""
...
OUT_PATH = os.path.join(_REPO, "jac", "jaclang", "compiler", "frontend", "python", "parser.jac")
...
class JacParserGenerator(ParserGenerator, GrammarVisitor):
    ...
    def _emit_header(self, filename: str) -> None:
        ...
        self.print("")
        self.print(
            f"GENERATED by scripts/python/grammar2jac.py from {GRAMMAR_PROVENANCE}"
        )
        self.print(f"(starts: eval, file; source tag: {base}). Do not edit by hand.")
        self.print('"""')
        self.print("")
        self.print("import from jaclang.compiler.frontend.python.token_model {")
        self.print(
        ...
        self.print("}")
        self.print("import from jaclang.compiler.frontend.python.peg_runtime {")
        ...
        self.print("}")
        self.print("import from jaclang.compiler.frontend.python.parser_actions {")
        ...
        self.print("}")
        self.print("import from jaclang.compiler.frontend.python.ast_nodes {")
