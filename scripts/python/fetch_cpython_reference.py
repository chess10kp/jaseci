"""Ensure the pinned CPython reference checkout exists for JacPython generators.

Reference pin: CPython 3.14.6, tag v3.14.6.

Usage:
    python scripts/python/fetch_cpython_reference.py
    python scripts/python/fetch_cpython_reference.py --check
"""
