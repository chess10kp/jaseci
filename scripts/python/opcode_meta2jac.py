...
Usage:
    python scripts/python/opcode_meta2jac.py
    python scripts/python/opcode_meta2jac.py --check
    python scripts/python/opcode_meta2jac.py --stdout
"""
...
OUT_PATH = os.path.join(_REPO, "jac", "jaclang", "runtime", "python", "opcode_meta.jac")
...
def generate() -> str:
    ...
    out: list[str] = []
    out.append("# GENERATED by scripts/python/opcode_meta2jac.py")
    out.append("#")
